...
from BaseFunctions2 import TimePropagate, TimePropagate_, draw_error_ellipse2d, showImage
import hdf5storage
...
#kf = KalmanFilter(np.array([[1989], [961], [0], [0]]), np.diag([900, 900, 400, 400]), 5, 6)
kf = KalmanFilter(np.array([[1890], [910], [0], [0]]), np.diag([900, 900, 400, 400]), 5, 6)
