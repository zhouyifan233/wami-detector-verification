...
numPositive = 1000000
numNegative = 2000000
numPositive_test = 10000
numNegative_test = 20000
...
'''Train the network'''
model.fit(X, Y, epochs=30, batch_size=100, validation_data=(X_vali, Y_vali), verbose=1, shuffle=True)

model.save('C:/Users/yifan/Google Drive/PythonSync/wasabi-detection-python/Models/BinaryClassification/saved_model.model')
writer_fid = open("C:/Users/yifan/Google Drive/PythonSync/wasabi-detection-python/Models/BinaryClassification/saved_image_norm.model", "wb")
